...
You can describe:
- **Prompts** - Specific task requests you want to reuse
- **Skills** - Teaching the AI HOW to do something
- **Agents** - Shaping WHO the AI is for this context

## Why Markdown Specifically?

Markdown hits a sweet spot:
- **Human-friendly** - Reads like normal text
- **Machine-friendly** - AI parses structure reliably
- **Workflow-friendly** - Version control, works everywhere
